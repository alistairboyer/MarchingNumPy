...
GEOMETRY_LOOKUP_TOP: NDArray[numpy.int8] = cupy.asarray(
    [
        _NONE,
        _TOP_HORIZONTAL,
        _NONE,
...
GEOMETRY_LOOKUP_BOTTOM: NDArray[numpy.int8] = cupy.asarray(
    [
        _NONE,
        _BOTTOM_VERTICAL,
        _BOTTOM_CORNER,
...
GEOMETRY_LOOKUP_TOP_: NDArray[numpy.int8] = cupy.asarray(
    [
        _NONE,
        _NONE,
        _TOP_HORIZONTAL_,
...
GEOMETRY_LOOKUP_BOTTOM_: NDArray[numpy.int8] = cupy.asarray(
    [
        _NONE,
        _BOTTOM_CORNER_,
        _BOTTOM_VERTICAL_,
